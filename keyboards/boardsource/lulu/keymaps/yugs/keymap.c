 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LOWER |LGUI | /Space  /       \Enter \  |RAISE |RGUI| RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                          KC_LALT,    LOWER, KC_LGUI, KC_SPC,  KC_ENT,   RAISE,   KC_LALT, KC_RGUI
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |   F1   |   F2   |   F3   |   F4   |  F5 |                    |   ^  |   \  |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |  F1  |  F2  |  UP  |  F4  |  F5  |  F6  |                    |  @   |  #   |  $   |   %  | F11  | F12  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |   `  | LEFT | DOWN | RIGHT|   $  |   %  |-------.    ,-------|   `  |   &  |   *  |   (  |   )  |   -  |
 * |------+------+------+------+------+------|   [   |    |    ]  |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------|   =   |   _  |   +  |   {  |   }  |   |  |
...
[_LOWER] = LAYOUT(
  ...
  KC_F1,   KC_F2,   KC_UP,   KC_F4,   KC_F5,   KC_F6,                     KC_AT,   KC_HASH,   KC_DLR,   KC_PERC,  _______,  _______,
...
[_RAISE] = LAYOUT(
  ...
  KC_F1,   KC_LEFT,   KC_DOWN,   KC_RGHT ,   KC_F5,   KC_F6,                       XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX,
