 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTL, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_LBRC,    KC_RBRC,    KC_L,    KC_SCLN, KC_QUOT,
...
[_LOWER] = LAYOUT(
  ...
  KC_CIRC, KC_LEFT, KC_DOWN,   KC_RGHT, KC_DLR,  KC_PERC,                   KC_PLUS, KC_DOWN, KC_UP, KC_RGHT, _______, _______,
