 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTL, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     TD(TD_H_PLUS),    TD(TD_J_LBRC),    TD(TD_K_RBRC),    KC_L,    KC_SCLN, KC_QUOT,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  TD(TD_RBRC_EQL),  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                          KC_LALT,    LOWER, KC_LGUI, KC_SPC,  KC_ENT,   RAISE,   KC_LGUI, TD(TD_RALT_CAPS)
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_LOWER] = LAYOUT(
  ...
  KC_F1,   KC_LPRN,   KC_UP,   KC_RPRN,   KC_F5,   KC_F6,                     KC_GRV,   KC_TILD,   KC_DLR,   KC_PERC,  _______,  KC_BSLS,
  KC_CIRC, KC_LEFT, KC_DOWN,   KC_RGHT, KC_DLR,  KC_PERC,                   KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, _______, _______,
